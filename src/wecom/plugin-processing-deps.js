...
export function createPluginProcessingDeps(context = {}) {
  ...
  return {
    botInboundDeps: {
      ...
      fetchMediaFromUrl: context.fetchMediaFromUrl,
      detectImageContentTypeFromBuffer: context.detectImageContentTypeFromBuffer,
      decryptWecomMediaBuffer: context.decryptWecomMediaBuffer,
      pickImageFileExtension: context.pickImageFileExtension,
      WECOM_TEMP_DIR_NAME: context.WECOM_TEMP_DIR_NAME,
      mkdir: context.mkdir,
      tmpdir: context.tmpdir,
      join: context.join,
      writeFile: context.writeFile,
      inferFilenameFromMediaDownload: context.inferFilenameFromMediaDownload,
      smartDecryptWecomFileBuffer: context.smartDecryptWecomFileBuffer,
